...
const ProductList = () => {
  ...
  products?.forEach((item) => {
    if (item._id) {
      ...
      console.error("Product item missing _id:", item);
    }
  });

  console.log("Rows:", rows); // Add this line to log the rows and check for duplicates or missing ids
      ...
      <div className="dashboard">
        ...
        <div className="productListContainer">
          ...
          {rows.length > 0 ? (
            ...
            <h1 id="productListHeading">No Products Found</h1>
          )}
        </div>
      </div>
    </Fragment>
